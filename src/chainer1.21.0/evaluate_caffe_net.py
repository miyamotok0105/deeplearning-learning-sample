...
i getted error.
python evaluate_caffe_net.py ../../model/imagenet_synset_words.txt alexnet ../../model/bvlc_alexnet.caffemodel --mean ../../model/ilsvrc_2012_mean.npy --gpu 0 --basepath ../../data/img/banana.jpg -B 1
"""
